	...
	function multiDelete()
	{
		...
		{
			var url='index.php?con=User&go=multiuserdelete';		
	...
	function userDelete(id) {	
		...
		if (choose==true){		
			var url='index.php?con=User&go=userdelete';		
	...
	{	
		var email = $("#email").val();			
		$.post("index.php?con=User&go=filter",{email:email}, function(data,status){				
			$('#result').hide();
			$('#Loading').show();
	    	$("#result").html(data); 
			$('#Loading').hide();
	...
	function logout()
	{		
		window.location.assign("index.php?con=User&go=logout");
	}
